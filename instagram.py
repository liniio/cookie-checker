    ...
    def checkCookie(cookie):
        try:
            ...
            with open(cookie_path, 'r', encoding='utf-8') as f:
                ...
                session.headers.update({'Accept-Encoding': 'identity', 'User-Agent': 'Instagram 123.0.0.0 Android'})

                response = session.get("https://i.instagram.com/api/v1/accounts/current_user/")
