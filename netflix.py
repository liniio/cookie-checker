    ...
    def checkCookie(cookie):
        try:
            ...
            with open(cookie_path, 'r', encoding='utf-8') as f:
                ...
                session.headers.update({'Accept-Encoding': 'identity', 'User-Agent': 'Netflix 123.0.0.0 Android'})

                response = session.get("https://www.netflix.com/api/shakti/v32b61380/user")
                ...
                if response.status_code == 200:
                    ...
                    output_file = os.path.join("hits", "netflix", f"{username.replace(' ', '_').lower()}.txt")
